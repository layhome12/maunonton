...
const Footer = () => {
  return (
    <footer className="bg-base-200 text-base-content">
      <div className="footer py-10 px-4 container mx-auto">
        <aside>
          ...
          <p className="my-3">Tempat nonton asyik tanpa iklan</p>
          <div className="mt-2">
            <a
              href="#"
        ...
        <nav>
          ...
          <a className="link no-underline hover:text-[#2f80ed]">Branding</a>
          <a className="link no-underline hover:text-[#2f80ed]">Design</a>
          <a className="link no-underline hover:text-[#2f80ed]">Marketing</a>
          <a className="link no-underline hover:text-[#2f80ed]">
            Advertisement
          </a>
        </nav>
        <nav>
          <header className="footer-title font-medium">Company</header>
          <a className="link no-underline hover:text-[#2f80ed]">About us</a>
          <a className="link no-underline hover:text-[#2f80ed]">Contact</a>
          <a className="link no-underline hover:text-[#2f80ed]">Jobs</a>
          <a className="link no-underline hover:text-[#2f80ed]">Press kit</a>
        </nav>
        <nav>
          <header className="footer-title font-medium">Legal</header>
          <a className="link no-underline hover:text-[#2f80ed]">Terms of use</a>
          <a className="link no-underline hover:text-[#2f80ed]">
            Privacy policy
          </a>
          <a className="link no-underline hover:text-[#2f80ed]">
      ...
      <div className="container px-5 mt-5 mx-auto">
        <div className="border-t-[1px] border-t-[#ffffff12]"></div>
      </div>
      <div className="py-5 text-center">
        <small>© PUDIDI STREAMING 2023</small>
      </div>
    </footer>
  );
};
